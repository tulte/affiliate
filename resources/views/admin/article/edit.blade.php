...
@endif
            ...
            <div class="panel panel-grey">
                    <form action="{{route('admin.article.update',[$article->id])}}" method="POST" autocomplete="off" class="sky-form" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                        ...
                        <fieldset>
                            <section>
                                ...
                                <label class="input">
                                    <input type="text" name="header" value="{{$article->header}}"/>
                                </label>
